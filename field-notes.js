(function(){
  ...
  const archiveMarkup=()=>`<section class="fn-archive" aria-labelledby="fn-archive-title"><div class="fn-shell"><div class="fn-archive-head"><p class="fn-eyebrow">Inside the network</p><h2 class="fn-heading" id="fn-archive-title">Built through the work.</h2><p class="fn-copy">Xflow began in 2015 with a clear understanding of Cape Town’s water-efficiency needs. The line continues through the experience, field knowledge and practical systems behind every enquiry.</p></div><div class="fn-timeline"><article><span class="fn-year">2015</span><i aria-hidden="true"></i><h3>Founded around water efficiency</h3><p>Xflow starts in Cape Town with a focus on water resilience for municipal and private clients.</p></article><article><span class="fn-year">20+</span><i aria-hidden="true"></i><h3>Experience inside the system</h3><p>Sulaiman’s more than 20 years with the City of Cape Town informs a practical, field-led point of view.</p></article><article><span class="fn-year">NOW</span><i aria-hidden="true"></i><h3>From network to next chapter</h3><p>Pressure management, metering, civil infrastructure and pipe products meet a changing water-solutions landscape.</p></article></div></div></section>`;
